...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == TYPE_LINEAR_LAYOUT){
            ...
            myViewHolder.swipeLayout.addSwipeListener(new SwipeLayout.SwipeListener() {
                @Override
            ...
            myGridViewHolder.swipeLayout.addSwipeListener(new SwipeLayout.SwipeListener() {
                @Override
                public void onStartOpen(SwipeLayout layout) {}
    ...
    private void bindMyViewHolder(MyViewHolder holder, int position) {
        ...
        holder.swipeLayout.findViewById(R.id.button_delet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int row = mNoteDbOpenHelper.deleteFromDbById(mBeanList.get(position).getId());
                if (row > 0) {
                    removeData(position);
                }
